...
# Спасибо django за готовую форму регистрации. # PasswordChangeForm наше представление для смены пароля
    ...
    return render(
        ...
        "answer.html",
        {
            ...
            "riddle": get_object_or_404(
                Riddle, pk=riddle_id), "error_message": error_message,
            "latest_messages":
                Message.objects
